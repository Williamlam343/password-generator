...
function pwgenerator() {
  ...
  while (
    (a == true && !upper.some((r) => generatedpw.includes(r))) ||
    (b == true && !num.some((r) => generatedpw.includes(r))) ||
    (c == true && !spchar.some((r) => generatedpw.includes(r))) ||
    (d == true && !lower.some((r) => generatedpw.includes(r)))
  ) {
    generatedpw = "";
    pwmaker();
  }
